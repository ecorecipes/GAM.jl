...
| [14_model_selection](https://github.com/ecorecipes/GAM.jl/tree/main/vignettes/14_model_selection) | End-to-end selection and diagnostics workflow: `select=true`, `k_check`, concurvity, influence, and NCV for correlated data |
