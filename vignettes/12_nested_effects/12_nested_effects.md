...
```
    ...
    Precompiling packages...
       6852.3 ms  ✓ GAM
      1 dependency successfully precompiled in 13 seconds. 118 already precompiled.
    Precompiling packages...
       5934.3 ms  ✓ GAM → GAMPlotsExt
      1 dependency successfully precompiled in 11 seconds. 239 already precompiled.
...
```
    ...
    NestedGamModel (Normal, IdentityLink)
      ...
      Deviance: 15.1456   Deviance explained: 92.7%
      Total EDF: 11.21   Scale: 0.03896
      Converged: true (14 outer iterations)
